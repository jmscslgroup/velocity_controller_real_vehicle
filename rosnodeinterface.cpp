...
// Generated 29-Jun-2021 17:29:23
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"velocity_controller_real_vehicle\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(velocity_controller_real_vehicle_M, (NULL));
        velocity_controller_real_vehicle_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(velocity_controller_real_vehicle_M)
                == (NULL)));
      ...
      return (!(rtmGetErrorStatus(velocity_controller_real_vehicle_M)
              ...
              (velocity_controller_real_vehicle_M));
    ...
    void NodeInterface::terminate(void)
    {
      if (mBaseRateThread.get()) {
        ...
        velocity_controller_real_vehicle_terminate();
        mNode.reset();
      }
    }
    ...
    {
      mRunModel = (rtmGetErrorStatus(velocity_controller_real_vehicle_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
